 ...
 */
class SplitrailMessagingService : FirebaseMessagingService() {

    companion object {
        const val TAG = "SplitrailFCM"
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        val title = message.notification?.title ?: "SPLITRAIL"
